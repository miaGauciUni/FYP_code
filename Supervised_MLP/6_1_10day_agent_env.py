...
if __name__=='__main__':
    initial_cash = 10000
    stock_data_files = {
        'AAPL':'2_validation_data/AAPL_processed_validation_10day.csv',
        'AMZN':'2_validation_data/AMZN_processed_validation_10day.csv',
        'META':'2_validation_data/META_processed_validation_10day.csv',
        'GOOGL':'2_validation_data/GOOGL_processed_validation_10day.csv',
        'MSFT':'2_validation_data/MSFT_processed_validation_10day.csv',
        'NVDA':'2_validation_data/NVDA_processed_validation_10day.csv',
        'TSLA':'2_validation_data/TSLA_processed_validation_10day.csv',
    }
    model_files = {
        s:f"6_stock_models/{s}_MLP_model_10day.pkl"
    ...
    with open("rolling_window_experiment/10day_model_values.pkl", "wb") as f:
        pickle.dump(env.portfolio_values, f)

    with open("0_Buy_and_Hold/10day_buy_hold_values.pkl", "wb") as f:
    ...
    }).to_csv("rolling_window_experiment/10day_portfolio_comparison.csv", index=False)

    import matplotlib.dates as mdates

    # Load dates
    dates = pd.read_csv("2_validation_data/AAPL_validation.csv")["Date"]
    ...
    plt.tight_layout()
    plt.savefig("Supervised_MLP_pf_10-day.png", dpi=600)
    plt.show()
